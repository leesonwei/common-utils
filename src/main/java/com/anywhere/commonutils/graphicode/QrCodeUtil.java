...
public class QrCodeUtil {
    ...
    public static void main(String[] args) throws WriterException {
        try {
            String logoFilePath = "F:/xfPlatform/xfWeb/xfWeiXin/xfp-xfWeiXin-parent/xfp-xfWeiXin/src/main/resources/static/html/images/scanlogo.png";
            
            getLogoQRCode(logoFilePath, "https://www.baidu.com/", "");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * @return
     */
    public static String getLogoQRCode(String logoFilePath, String qrUrl, String productName) {
        /**
         * 动态path
         */
        // String logoFilePath =
        ...
        try {
            ...
            return zp.addLogo_QRCode(bim, new File(logoFilePath), new LogoConfig(), productName);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
        try {
            byte[] arrByte = addLogo_Base_QRCode(bim, logoPic, logoConfig, productName);
          final String imageBase64QRCode = EncryptUtil.getInstance().Base64Encode(arrByte);
     ...
     * @return
     */
    public byte[] addLogo_Base_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
        if (logoConfig == null) {
        ...
        try {
            ...
            if (testFlag) {
                ImageIO.write(image, "png", new File("D:/1-" + System.currentTimeMillis() + "test.png"));
            }
